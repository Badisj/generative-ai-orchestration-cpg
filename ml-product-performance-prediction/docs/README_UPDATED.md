...
Need help?
----------
Tell me which of the following you'd like next and I will implement it:
- Add hyperparameter search + CV to the training script.
- Add a notebook that loads saved models and demonstrates inference.
- Export an executed HTML report with metrics and plots to `outputs/`.
